    ...
    return (
      ...
      >
            ...
            <div className="flex items-center space-x-8">
              {(display.show_date || display.show_time) && (
                <div className="text-right">
                  ...
                  >
                    {display.show_date && formatDate(currentTime)}
                    {display.show_date && display.show_time && ' - '}
                    {display.show_time && (
        ...
        <div className="grid grid-cols-3 h-[90vh] w-full">
          ...
          <div className={`p-8 relative overflow-hidden h-[90vh] ${display.show_carrosel && carouselImages.length > 0 ? 'col-span-1' : 'col-span-3 grid grid-cols-2 justify-center items-start gap-6'}`}
            style={{
          ...
          >
            ...
            <div className="col-span-1">
              ...
              {display.show_ticket_history && ticketHistory.length > 0 && (
                <>
                  <div className="text-center mb-4 text-white/80 text-2xl font-medium">
                    Histórico de chamadas
                  </div>
                  <div className="mb-6 relative z-10">
                    <div className="bg-white/10 backdrop-blur-md rounded-xl p-4 border border-white/20">
                      <div className="grid grid-cols-3 items-center justify-between text-white">
                        <span className="font-semibold text-left">SENHA</span>
                        <span className="font-semibold text-center">GUICHÊ</span>
                        <span className="font-semibold text-right">HORA</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4 relative z-10">
                    {ticketHistory.map((ticket, index) => (
                      <div
                        ...
                        className={`backdrop-blur-sm rounded-xl p-4 border transition-all duration-300 ${ticket.is_current
